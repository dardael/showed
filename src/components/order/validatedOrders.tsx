...
export default function ValidatedOrders() {
    ...
    useEffect(() => {
        getOrders(OrderState.VALIDATED).then((fetchedOrders) => {
    ...
    const validateOrder = async (order: Order) => {
        ...
        notification.handlePromise(pendingRequest, {
            loading: 'Confirmation de la réception de la commande en cours',
            success: 'La commande a été réceptionnée avec succès',
